...
const ChatContainer = () => {
  ...
  return (
    <div className="h-full flex-1 flex flex-col min-w-0 bg-transparent relative overflow-hidden">
      ...
      {/* ---------------- BOTTOM INPUT BAR ---------------- */}
      <div className="p-3 bg-[#131126]/60 backdrop-blur-md flex-shrink-0">
        <form onSubmit={handleSendMessage} className="flex items-center gap-2">
          <div className="flex flex-1 items-center bg-[#221d3e]/90 border border-white/10 rounded-full px-4 py-2">
            <input
              type="text"
              value={text}
          ...
          <button
            ...
            className="w-9 h-9 rounded-full bg-gradient-to-r from-purple-500 to-violet-600 flex items-center justify-center text-white shadow-lg shadow-purple-600/40 hover:scale-105 active:scale-95 transition-transform disabled:opacity-40 cursor-pointer flex-shrink-0"
          >
